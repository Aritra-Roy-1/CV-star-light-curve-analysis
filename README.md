...
### 2. Data Cleaning
- TESS: 2-minute cadence → finely sampled data → mean-normalisation (stable dense sampling) → NaN removal → 3σ outlier clipping
